                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="stock_quantity" class="form-control" placeholder="100"
                                        min="0" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="max_stock_level" class="form-control" placeholder="1000"
                                        min="0" required>
                                    <span class="input-group-text">adet</span>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="description" class="form-control" rows="3"
                                placeholder="Ürün açıklaması (isteğe bağlı)"></textarea>
                        </div>
            ...
            <form class="row row-cols-lg-auto g-2 align-items-center" method="get"
                ...
                <div class="col-12">
                    <select name="status" class="form-select form-select-sm">
                        ...
                        <option value="low_stock" @selected(request('status') === 'low_stock')>Düşük Stok</option>
                    </select>
                ...
                @if(request()->filled('q') || request()->filled('category') || request()->filled('status'))
                    <div class="col-12">
                        <a href="{{ route('admin.products.index') }}" class="btn btn-sm btn-outline-secondary">Temizle</a>
                    </div>
                @endif
            </form>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <button type="button" class="btn btn-outline-primary" onclick="editProduct({{ $p->id }})"
                                        title="Düzenle">
                                    ...
                                    <button type="button" class="btn btn-outline-danger" onclick="deleteProduct({{ $p->id }})"
                                        title="Sil">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" name="min_stock_level" id="edit_min_stock_level"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" name="max_stock_level" id="edit_max_stock_level"
                                        class="form-control" min="0" required>
                                    <span class="input-group-text">adet</span>
                                </div>
                            </div>
