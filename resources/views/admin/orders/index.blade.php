...
@section('content')
    ...
    <div class="row mb-4">
        <div class="col-lg-2 col-md-4 col-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center p-3">
                    <div class="bg-primary bg-opacity-10 rounded-circle p-2 mx-auto mb-2"
        ...
        <div class="col-lg-2 col-md-4 col-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center p-3">
                    <div class="bg-warning bg-opacity-10 rounded-circle p-2 mx-auto mb-2"
                        style="width: 40px; height: 40px;">
        ...
        <div class="col-lg-2 col-md-4 col-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center p-3">
                    <div class="bg-success bg-opacity-10 rounded-circle p-2 mx-auto mb-2"
                        style="width: 40px; height: 40px;">
        ...
        <div class="col-lg-2 col-md-4 col-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center p-3">
                    ...
                    <h6 class="fw-bold text-success mb-0" id="stat-revenue">₺{{ number_format($stats['today_revenue'], 0) }}
                    </h6>
            ...
            <form method="GET" class="row g-3" id="filterForm">
                <div class="col-lg-2 col-md-4">
                    ...
                    <select class="form-select" name="status">
                        ...
                        <option value="delivered" {{ request('status') == 'delivered' ? 'selected' : '' }}>Teslim Edildi
                        </option>
...
@push('scripts')
    <script>
        ...
        function updateOrderRowStatus(orderId, newStatus) {
            ...
            const statusCell = row.children[3]; // Durum sütunu
            if (statusCell) {
            ...
            // İşlemler sütunundaki butonları güncelle (son sütun hedeflenir — daha dayanıklı)
        ...
        // YENİ: Toplu sipariş silme
        function bulkDeleteOrders() {
            if (selectedOrders.length === 0) {
                showAlert('warning', 'Lütfen silmek için sipariş seçin');
                return;
            }
            if (!confirm(`${selectedOrders.length} siparişi tamamen silmek istediğinize emin misiniz? Bu işlem geri alınamaz!`)) {
                return;
            }

            const deleteButton = document.querySelector('button[onclick="bulkDeleteOrders()"]');
            const originalText = deleteButton.innerHTML;
            deleteButton.disabled = true;
            deleteButton.innerHTML = '<i class="spinner-border spinner-border-sm" role="status"></i> Siliniyor...';
            ...
            fetch('/admin/orders/bulk-delete', {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        showAlert('danger', data.message || 'Silme işlemi başarısız');
                    }
        ...
        function updateStats() {
            fetch('/admin/orders/stats/realtime')
                ...
                .then(data => {
                    ...
                    document.getElementById('stat-revenue').textContent = '₺' + Number(data.stats.today_revenue || 0).toLocaleString();
                })
        ...
        setInterval(updateStats, 30000); // 30 sn

        // Sayfa yüklendiğinde
        document.addEventListener('DOMContentLoaded', function () {
            setInterval(refreshOrders, 300000); // 5 dk
        });
    </script>
@endpush