...
<head>
    ...
    <title>Restoran Admin Giriş</title>
...
<body>
    ...
    @stack('auth_navbar_styles') {{-- navbar inline stilleri --}}
        ...
        <div class="row g-0 auth-card mt-4" style="margin-top:72px!important;">
            ...
            <div class="col-lg-6 d-none d-lg-flex align-items-center justify-content-center p-5 hero-pane">
                <div class="text-center">
                    ...
                    <p class="muted">Masaları, ürünleri ve sipariş akışını tek yerden yönetin.</p>
                </div>
            </div>

            {{-- Sağ / form --}}
            <div class="col-lg-6 bg-white p-4 p-md-5">
                <h4 class="mb-3"><i class="bi bi-star-fill text-primary me-2"></i>Restoran Admin Giriş</h4>
